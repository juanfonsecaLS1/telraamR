...
```
    ...
    ##  $ instance_id        : num [1:7939] 455 4307 2995 3297 1034 ...
    ##  $ mac                : num [1:7939] 2.02e+14 3.53e+14 2.02e+14 2.02e+14 2.02e+14 ...
    ##  $ user_id            : num [1:7939] 1 1 3296 3600 1851 ...
    ##  $ segment_id         : num [1:7939] 3.5e+05 9.0e+09 9.0e+09 9.0e+09 9.0e+09 ...
    ##  $ direction          : logi [1:7939] FALSE TRUE FALSE TRUE TRUE TRUE ...
    ##  $ status             : chr [1:7939] "non_active" "non_active" "stopped" "non_active" ...
    ##  $ manual             : logi [1:7939] FALSE FALSE FALSE FALSE FALSE FALSE ...
    ##  $ time_added         : POSIXct[1:7939], format: "2019-08-15 08:43:49" "2021-10-26 12:41:44" ...
    ##  $ time_end           : POSIXct[1:7939], format: NA "2021-11-03 13:54:46" ...
    ##  $ last_data_package  : POSIXct[1:7939], format: NA NA ...
    ##  $ first_data_package : POSIXct[1:7939], format: NA NA ...
    ##  $ pedestrians_left   : logi [1:7939] TRUE TRUE TRUE FALSE FALSE FALSE ...
    ##  $ pedestrians_right  : logi [1:7939] TRUE TRUE TRUE FALSE FALSE TRUE ...
    ##  $ bikes_left         : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ bikes_right        : logi [1:7939] TRUE TRUE TRUE TRUE FALSE TRUE ...
    ##  $ cars_left          : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ cars_right         : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ is_calibration_done: chr [1:7939] "no" "no" "yes" "no" ...
    ##  $ hardware_version   : num [1:7939] 1 1 1 1 1 1 1 NA 1 1 ...
