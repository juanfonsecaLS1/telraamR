...
```
    ...
    ## tibble [7,939 × 19] (S3: tbl_df/tbl/data.frame)
    ##  $ instance_id        : num [1:7939] 5641 6818 6927 3454 5729 ...
    ##  $ mac                : num [1:7939] 2.02e+14 3.50e+14 2.02e+14 2.02e+14 2.02e+14 ...
    ##  $ user_id            : num [1:7939] 6121 7287 3510 3751 6187 ...
    ##  $ segment_id         : num [1:7939] 9e+09 9e+09 9e+09 9e+09 9e+09 ...
    ##  $ direction          : logi [1:7939] TRUE TRUE FALSE TRUE TRUE TRUE ...
    ##  $ status             : chr [1:7939] "stopped" "non_active" "stopped" "active" ...
    ##  $ manual             : logi [1:7939] FALSE FALSE FALSE FALSE FALSE FALSE ...
    ##  $ time_added         : POSIXct[1:7939], format: "2022-07-08 16:33:42" "2023-04-03 18:43:54" ...
    ##  $ time_end           : POSIXct[1:7939], format: "2023-05-23 14:26:42" NA ...
    ##  $ last_data_package  : POSIXct[1:7939], format: "2023-05-23 14:25:50" "2023-06-17 07:30:08" ...
    ##  $ first_data_package : POSIXct[1:7939], format: "2022-07-08 16:34:10" "2023-04-03 18:45:09" ...
    ##  $ pedestrians_left   : logi [1:7939] TRUE TRUE FALSE FALSE TRUE TRUE ...
    ##  $ pedestrians_right  : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ bikes_left         : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ bikes_right        : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ cars_left          : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ cars_right         : logi [1:7939] TRUE TRUE TRUE TRUE TRUE TRUE ...
    ##  $ is_calibration_done: chr [1:7939] "yes" "no" "yes" "yes" ...
    ##  $ hardware_version   : num [1:7939] 1 2 1 1 1 1 1 1 1 NA ...
...
```
    ...
    ## Classes 'sf' and 'data.frame':   6517 obs. of  2 variables:
    ##  $ oidn    : num  9e+09 9e+09 9e+09 9e+09 9e+09 ...
    ##  $ geometry:sfc_MULTILINESTRING of length 6517; first list element: List of 1
