...
**NOTE:** The token has to be set at the beginning of every session. Alternatively, the authentication token can be provided as a parameter of all functions of this package.
